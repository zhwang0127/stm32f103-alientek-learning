...
void atk_oled_show_chinese(uint8_t x, uint8_t y, uint8_t index);                           /* OLED显示16x16中文字符(逐列式字库) */
void atk_oled_show_chinese_str(uint8_t x, uint8_t y, const uint8_t *indices, uint8_t len); /* OLED显示中文字符串 */
#endif
